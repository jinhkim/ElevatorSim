	...
	public class ElevatorDistanceGraph extends ApplicationFrame
{
      ...
      public ElevatorDistanceGraph(final String title, Controller c, Boolean B)
       {
       super(title);
       controller = c;
       ElevatorCount = c.getElevNum();
     ...
     class ElevatorData implements Runnable 
    {
        ...
        public void run() 
        {
        	...
        	float[] temp = Log.getTotalFloorsTravelled();
...
//                }
     ...
     public void Print(){
    	   ...
    	   try {
           	ChartUtilities.saveChartAsPNG(new File("ElevatorDistanceGraph.jpg"), chart, 500, 270, null);
           } catch (Exception e) {
